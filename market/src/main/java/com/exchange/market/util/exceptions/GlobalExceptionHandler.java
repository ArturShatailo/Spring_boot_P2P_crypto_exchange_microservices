...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BuyAdvertNotFoundException.class)
    protected ResponseEntity<?> handleCardDetailsNotFoundException(BuyAdvertNotFoundException ex, WebRequest request) {
